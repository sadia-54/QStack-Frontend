  ...
  return (
    <div className="bg-surface-elevated rounded-2xl p-4 border border-border">
      <div className="flex items-center justify-between border-b border-border-soft pb-3 mb-3">
        <div className="text-base font-semibold text-primary">QStack</div>
        <div className="text-meta text-text-muted inline-flex items-center gap-2">
          <SearchOutlined />
          Search…
        </div>
      </div>
      ...
      <div className="grid grid-cols-4 gap-3 h-[calc(100%-52px)]">
        ...
        <div className="col-span-1 bg-surface rounded-xl p-3 space-y-3 border border-border-soft">
          <div className="text-meta text-text-secondary font-semibold">Navigation</div>
          {["Questions", "My Feed", "Tags", "Profile"].map((x) => (
            <div key={x} className="text-meta text-text-secondary px-2 py-2 rounded-lg hover:bg-hover-bg transition">
              {x}
            </div>
          ))}
          <div className="mt-auto text-meta text-text-muted">
            online • 12 users
          </div>
        </div>
        ...
        <div className="col-span-3 bg-surface rounded-xl p-3 flex flex-col gap-3 border border-border-soft">
          ...
          <div className="bg-surface rounded-xl p-3 border border-border">
            <div className="text-meta text-text-secondary font-semibold">Top Answer</div>
            <div className="text-meta text-text-secondary mt-1">
          ...
          {/* Reply area */}
          <div className="mt-auto flex items-center justify-between text-meta text-text-muted">
            <span>▲ 24 votes</span>
            <span>💬 8 answers</span>
            <span>⭐ accepted</span>
          </div>
